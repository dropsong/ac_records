...
https://github.com/dropsong/ac_records/blob/master/leetcode/238.cc
...
https://github.com/dropsong/ac_records/blob/master/leetcode/189.cc

给定一个整数数组 nums，将数组中的元素向右轮转 k 个位置，其中 k 是非负数。

思路：
1. 自己用两只笔(表示两截数组)朝同一个方向摆。
2. 反转整个整体（两只笔转180度）
3. 分别再180度 反转两个单笔
4. 发现两只笔（两截数组）完成了首尾互换，达到题目要求
...
https://github.com/dropsong/ac_records/blob/master/leetcode/51.cc

题面略。

很恶心的一道题，虽然可以独立写出来，不过在面试的紧张环境下不太可能写出来，建议压力面试官换一题。

## 螺旋矩阵

http://leetcode.cn/problems/spiral-matrix/description/

https://github.com/dropsong/ac_records/blob/master/leetcode/54.cc

给你一个 m 行 n 列的矩阵 matrix ，请按照 顺时针螺旋顺序 ，返回矩阵中的所有元素。

模拟题。通过循环和转向计数控制是否 done.
...
https://github.com/dropsong/ac_records/blob/master/leetcode/155.cc

设计一个支持 push ，pop ，top 操作，并能在常数时间内检索到最小元素的**栈**。
...
https://github.com/dropsong/ac_records/blob/master/leetcode/199.cc

给定一个二叉树的 根节点 root，想象自己站在它的右侧，按照从顶部到底部的顺序，返回从右侧所能看到的节点值。

bfs, 每次进入新一层的时候记录 pre 节点的值。
